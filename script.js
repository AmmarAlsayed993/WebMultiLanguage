...
if(getLanuage === "arabic"){
    title.innerHTML = "مبرمج عمار";
    welcome.innerHTML = "مرحبا بكم  في صفحة مبرمج عمار";
    ...
    title.innerHTML = "Coder Ammar";
    welcome.innerHTML = "Welcome to website of Coder Ammar";
